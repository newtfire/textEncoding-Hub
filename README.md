...
## Ready Reference for Command line + Git/GitHub/Codeberg
* Setting up SSH Keys and your local gitconfig: <https://github.com/newtfire/textEncoding-Hub/blob/main/ssh-key-and-gitconfig-setup.md>
* Here is a quick and handy list of git commands: <https://github.com/newtfire/textEncoding-Hub/blob/main/GitCommands.md>
